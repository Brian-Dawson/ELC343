...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ca1ac49a-5483-41b1-b5a9-84c085cb01f7/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("fe51ed36-5207-4c69-aad3-e1ceb3c77e72"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    LED_Driver_v1_10_1 LED_Driver_1 (
        .clock(1'b0),
        .seg(Net_10[7:0]),
        .com(Net_11[3:0]));
